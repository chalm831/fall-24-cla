...
numerical = ["New media objects, whether created from scratch on computers or converted from analog media sources, are composed of digital code; they are numerical representations." "New media objects can be defined with a mathematical function" "A new media object is subject to algorithmic manipulation"]
